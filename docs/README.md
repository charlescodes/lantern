...
| Snapshot/recording | v23 | [platform contract](./platform.md) |
| Authoring map | v7 | [map-authoring contract](./notes/map-authoring-foundation.md) |
...
- Snapshot and command-recording schema: v23.
- Authoring-map schema: `lantern-authoring-map` v7; v6, v5, v4, v3, v2, v1, and legacy map/scenario documents migrate explicitly.
