...
| [Doors and dynamic occlusion](./doors-and-dynamic-occlusion.md) | Candidate | Frames the bounded geometry, camera, replay, AI, and renderer questions behind hinged doors, round pillars, and moving sight blockers. |
