...
| AI and visibility | `encounterDiagnostics`, `enemyDiagnostics`, `aiView`, `trueSight`, `isVisible`, `navigationTopology`, `navigationRouteEvents` | `setAiView` | Topology reads are detached and bounded; AI View and TrueSight calls are diagnostic/presentation controls and do not grant simulation knowledge. |
