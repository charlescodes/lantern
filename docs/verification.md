...
For M1E, follow the dedicated
[mechanism acceptance route](./notes/authored-mechanisms.md#acceptance)
at `?arena=mechanisms` and `?arena=mechanisms-pass-b`, then repeat with
`&renderer=3d`. Its manual browser/GPU
