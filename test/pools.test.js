...
import { ParticlePool, ProjectilePool } from "../src/sim/pools.js";
...
test("projectile swap-and-pop copies every component, including stable ID", () => {
  ...
  const lastId = pool.spawn({ x: 100, z: 200, vx: 300, vz: 400, lifetime: 500, radius: 0.3 });
  pool.previousX[2] = 91;
  pool.previousZ[2] = 92;
  pool.age[2] = 93;
  pool.removeSwap(0);
  ...
  assert.deepEqual(
    ...
    { id: lastId, x: 100, z: 200, previousX: 91, previousZ: 92, vx: 300, vz: 400, age: 93, lifetime: 500, radius: Math.fround(0.3) },
  );
});
